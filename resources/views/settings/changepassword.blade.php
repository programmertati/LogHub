                        ...
                        <div class="form-group">
                            <div class="info-status1">
                                ...
                                <span class="text-status1"><b>Password Indicator :</b><br>
                                    ...
                                    <i class="fa-solid fa-circle" style="font-size: 5px"></i> Medium Password : [a-z] + [number]<br>
                                    <i class="fa-solid fa-circle" style="font-size: 5px"></i> Strong Password : [a-z] + [number] + [!,@,#,$,%,^,&,*,?,_,~,(,)]
                                </span>
                            </div>
