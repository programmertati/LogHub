                            ...
                            <div class="menu-checklist border border-1 border-darkss p-2 rounded-xl" data-id="${titlechecklist.id}">
                                ...
                                <div class="header-checklist flex justify-content">
                                    ...
                                    <form id="myFormTitleUpdate${titlechecklist.id}" method="POST" class="update-title">
                                        ...
                                        <input type="text" class="isian-title border border-1 border-darks w-402 p-2 rounded-xl" style="font-size: 17px" id="titleChecklistUpdate${titlechecklist.id}" name="titleChecklistUpdate" placeholder="Enter a title" value="${titlechecklist.name}">
                                ...
                                <div class="checklist-all gap-2" id="checklist-all-${titlechecklist.id}">
                                    <form id="checklistAllForm${titlechecklist.id}" method="POST">
                                        @csrf
                                ...
                                <button type="button" class="btn btn-outline-info" id="AddChecklist${titlechecklist.id}"><i class="fa-solid fa-plus" aria-hidden="true"></i> Add an Item...</button>
                                <!-- Tambah baru checklist -->
